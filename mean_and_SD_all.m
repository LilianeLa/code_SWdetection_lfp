% Function computing the means and standard deviations of the amounts of SWs, operant actions before which there are pre-waves, operant actions after which there are post-waves  and random windows in which there are slow waves
...
% Mean and SD for the amount of slow waves 
...
% Mean and SD for the amount of  operant actions before which there are pre-waves 
...
% Mean and SD for the amount of operant actions after which there are post-waves 
...
% Mean and SD for the amount of random windows in which there are slow waves
